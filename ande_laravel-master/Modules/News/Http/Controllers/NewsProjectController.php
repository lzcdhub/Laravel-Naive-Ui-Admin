...
use Modules\News\Entities\NewsProject as ThisModel;
...
class NewsProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $field = ['id', 'category_id', 'title', 'status_f', 'created_at'];
    ...
    public function store(Request $request)
    {
        ...
        unset($createData['project_area_text']);

        $model = ThisModel::create($createData);
        if ($model->id) {
    ...
    public function show($id)
    {
        ...
        $data->project_area_text = $data->area->getAllName;
