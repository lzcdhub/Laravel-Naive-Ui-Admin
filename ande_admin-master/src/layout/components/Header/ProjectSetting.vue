  ...
  >
    <n-drawer-content :title="title" :native-scrollbar="false">
      <div class="drawer">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> 网页动画 </div>
          <div class="drawer-setting-item-action">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      function closeDrawer() {
        ...
        // storage.set('userDesignStore', designStore);
        // storage.set('userSettingStore', settingStore);
        //console.log(designStore);
        //console.log(JSON.parse(JSON.stringify(designStore)));
      }
